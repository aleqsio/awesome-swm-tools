...
* [Fishjam](https://github.com/fishjam-dev/fishjam) - A general-purpose **media server** (written in Elixir) that supports WebRTC, HLS, RTSP, and SIP, forming the backend for many real-time video applications.
